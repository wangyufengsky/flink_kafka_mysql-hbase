...
public class MysqlSinBalance extends RichSinkFunction<List<clearBean>> implements Serializable {
    ...
    private void doDeal(List<clearBean> list){
        ...
        Map<String,List<DataBaseTableBean>> map=dataBaseTableBeans.stream().parallel().collect(Collectors.groupingBy(DataBaseTableBean::getDataBase));
