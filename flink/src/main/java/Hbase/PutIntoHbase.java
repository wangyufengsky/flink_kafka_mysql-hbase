...
public class PutIntoHbase {
    ...
    public static void main(String[] args) {
        for(int i=1;i<4;i++){
            ...
            Thread t=new Thread(()->{
                ...
                System.out.println("第"+ finalI +"线程执行开始");
                long startTime=System.currentTimeMillis();
                read("/data/x"+finalI,init());
    ...
    public static Table init(){
        ...
        try{
            ...
            configuration.set("hbase.zookeeper.quorum", "10.137.8.22,10.137.8.25,10.137.8.26,10.137.8.34,10.137.8.35,10.137.8.36,10.137.8.38,10.137.8.39,10.137.8.40,10.141.13.18,10.141.13.17,10.141.13.16,10.141.13.15,10.141.13.14,10.141.13.13,10.141.13.19,10.141.13.20,10.141.13.21");
