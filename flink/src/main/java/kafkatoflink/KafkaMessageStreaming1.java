...
public class KafkaMessageStreaming1 {
        ...
        public static void main(String[] args) throws Exception {
            ...
            //传入的是kafka中的topic
            FlinkKafkaConsumer010<String> consumer = new FlinkKafkaConsumer010<>("total4", new SimpleStringSchema(), props);
            //consumer.assignTimestampsAndWatermarks(new MessageWaterEmitter());
            DataStream<Detail> keyedStream = env
                    .addSource(consumer)
...
/*                                if(totals.containsKey(detail.getOnlyone())){
            ...
            DataStream<List<Detail>> keyedStream1 =keyedStream
            ...
            keyedStream1.addSink(new HbaseSink4Total());
