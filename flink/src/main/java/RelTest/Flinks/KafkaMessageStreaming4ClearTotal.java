...
import RelTest.Sink.ClearTotalSink;
...
public class KafkaMessageStreaming4ClearTotal {
        ...
        public static void main(String[] args) throws Exception {
            ...
            props.setProperty("group.id", "clear_total");
            ...
            FlinkKafkaConsumer010<String> consumer=new FlinkKafkaConsumer010<>("clear_total",new SimpleStringSchema(), props);
            ...
            try {
                keyedStream.addSink(new ClearTotalSink());
            }catch (Exception e){
                e.printStackTrace();
            }
