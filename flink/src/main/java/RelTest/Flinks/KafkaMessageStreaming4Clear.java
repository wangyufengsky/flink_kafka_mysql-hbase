...
public class KafkaMessageStreaming4Clear {
        ...
        public static void main(String[] args) throws Exception {
            ...
            props.setProperty("group.id", "clear");
            ...
            FlinkKafkaConsumer010<String> consumer=new FlinkKafkaConsumer010<>("clear",new SimpleStringSchema(), props);
            ...
            try {
                keyedStream.addSink(new ClearSink());
            }catch (Exception e){
                e.printStackTrace();
            }
